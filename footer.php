				...
				<div class="col col1 fl n33 plr10">
					...
					<ul>
						<?php //dynamic_sidebar('sidebar-footer-2');
							echo RSS_list('https://blog.atlatszo.hu/kimittud.xml', 5);
						?>
					</ul>
			...
			<div class="footer footer2 pt25 mt50">
				...
				<div class="ib n30 copyright vm"><img src="<?php bloginfo('template_url')?>/i/atlatszo-logo-footer.svg" width="116" height="47" alt="<?php bloginfo('name')?>" /></a></div><div class="footermenu ib n70 vm">
					<ul class="footermenu ar">
						<li><a href="http://creativecommons.org/licenses/by-nc-sa/2.5/hu/">CC BY-NC-SA 2.5</a></li>
						<li><a href="https://atlatszo.hu/impresszum/">Impresszum</a></li>
						<li><a href="https://atlatszo.hu/az-atlatszo-hu-blogszabalyzata/">Blogszabályzat</a></li>
						<li><a href="http://branditorial.hu/" target="_blank">Powered by Branditorial</a></li>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-48920123-6"></script>
<script>
...
?>
<?php
if ($blogurl=="pcblog.atlatszo.hu") { ?>

	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-90558886-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'UA-90558886-1', { 'anonymize_ip': true });
	</script>

<?php } ?>
<?php
if ($blogurl=="erdely.atlatszo.hu") { ?>

	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-48920123-22"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'UA-48920123-22', { 'anonymize_ip': true });
	</script>
