		...
		<div class="post_content">
			...
			<?php if (get_post_format()=="image" && has_post_thumbnail()) { ?>
				...
				<section class="heading n9">		
					<?php if ($the_cat) { ?><a href="<?php echo get_category_link(get_first_cat_id()); ?>" class="the_category cat_linkbox mt40"><?php echo get_first_cat_name();?></a><?php } ?>
					<h1 class="the_title post_title fs48px ttn cdarkgrey mb10 pt30"><?php the_title(); ?></h1>
				</section>
			...
			<?php } else { ?>
				...
				<section class="heading n9">
					<?php if ($the_cat) { ?><a href="<?php echo get_category_link(get_first_cat_id()); ?>" class="the_category cat_linkbox mt40"><?php echo get_first_cat_name();?></a><?php } ?>
					<h1 class="the_title post_title fs48px ttn cdarkgrey mb30 pt30"><?php the_title(); ?></h1>
				</section>
...
<html><body>', '', $content_with_filters);
					...
					?>
						...
						<div id="the_tags" class="ttu cgrey ls1 pt60"><?php the_tags( '', ' <strong class="separator plr10 cgrey">/</strong> ', '' ); ?></div>
