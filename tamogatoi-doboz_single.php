...
$the_query_tamogatoi_doboz=new WP_Query($args_tamogatoi_doboz);
while ($the_query_tamogatoi_doboz->have_posts()) : $the_query_tamogatoi_doboz->the_post();
	...
	<div class="n9 pr">
		<div class="shell">
			<div class="n50 pl50">
				...
				<?php echo do_shortcode('[mc4wp_form id="24261"]'); ?>
			</div>
		</div>
	</div>
</div>
